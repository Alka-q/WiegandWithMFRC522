...
#include "stm8s_it.h"
 ...
 extern unsigned char BufCntM;
 extern unsigned char ComMifare_in;
 extern void ComMifare_Uart1_ISR(void); 
 ...
 */
 INTERRUPT_HANDLER(UART1_RX_IRQHandler, 18)
 {
   if(UART1_GetITStatus(UART1_IT_RXNE) != RESET){
      ComMifare_in = UART1_ReceiveData8();
      ComMifare_Uart1_ISR();
   // USART_ITConfig(UART5, USART_IT_RXNE, DISABLE);   //Disable the UART5 Recieve interrupt
   }
   BufCntM = 0;
